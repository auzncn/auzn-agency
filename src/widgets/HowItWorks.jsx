...
export default function HowItWorks() {
    return (
        <div>
            <SectionHeading title='工作流程'
                subtitle='如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作'></SectionHeading>
            <div className='mt-14 grid grid-cols-2 md:grid-cols-3 gap-6'>
                {
                    [1, 2, 3, 4, 5, 6].map((v) => (
                        <div key={v} className=' grid justify-items-center gap-y-2'>
                            ...
                            <p className=' text-xl font-black'>初步沟通</p>
                            <p className=''>初步沟通初步沟通初步沟通初步沟通初步沟通初步沟通初步</p>
                        </div>
                    ))
                }
            </div>
